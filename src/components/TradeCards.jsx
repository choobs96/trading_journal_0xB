        ...
        <div className="overlay" onClick={handleOverlayClick} >
            ...
            <div className="trade-content">
                ...
                <p>
                    ...
                    <span className = {results==="Profit" ?"outcomeProfit":"outcomeLost"}>{results}</span>
                </p>
                <p>
                    <strong >PNL:</strong> $
                    <span className = {results ?"outcomeProfit":"outcomeLost"}>{trade.side === "long"
                        ? Math.round(trade.quantity * (trade.exit_price - trade.entry_price)): Math.round(trade.quantity * -1*(trade.exit_price - trade.entry_price))}</span>
                </p>
            </div>
            </div>
